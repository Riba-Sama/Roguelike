...
Descriptions={'a':['Attacks all enemies around you.',4,1],'e':['Exhausts one enemy.',4,0],'x':['Run in straight line until you hit enemy or tire out.',4,0],'z':['Jump, damaging adjacent enemies.',12,0],'w':['Upgrades vitality and heals.',12,0],'d':['Swap yourself with selected enemy, damaging them.',12,0],'s':['Manage your abilities.',20,10]}
Coolness=3
Magic_value=4
TP_value=4
TP_cost=2
