...
Descriptions={'a':['Attacks all enemies around you.',4],'e':['Exhausts one enemy.',4],'x':['Run in straight line until you hit enemy or tire out.',4],'z':['Jump, damaging adjacent enemies.',10],'w':['Upgrades vitality and heals.',10],'d':['Swap yourself with selected enemy, damaging them.',10],'s':['Manage your abilities.',20]}
Coolness=3
Magic_value=4
Magic_distance=6
XP=0
