...
Descriptions={'a':['Attacks all enemies around you.',4],'e':['Exhausts one enemy.',4],'x':['Run in straight line until you hit enemy or tire out.',4],'z':['Jump, damaging adjacent enemies.',12],'w':['Upgrades vitality and heals.',12],'d':['Swap yourself with selected enemy, damaging them.',12],'s':['Manage your abilities.',20]}
Coolness=3
Magic_value=4
TP_value=4
TP_cost=2
